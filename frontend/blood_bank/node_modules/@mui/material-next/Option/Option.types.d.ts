...
export type OptionTypeMap<AdditionalProps = {}, RootComponent extends React.ElementType = 'li'> = ExtendButtonBaseTypeMap<{
    props: AdditionalProps & OptionOwnProps;
    defaultComponent: RootComponent;
}>;
export type OptionProps<RootComponent extends React.ElementType = OptionTypeMap['defaultComponent'], AdditionalProps = {}> = OverrideProps<OptionTypeMap<AdditionalProps, RootComponent>, RootComponent> & {
