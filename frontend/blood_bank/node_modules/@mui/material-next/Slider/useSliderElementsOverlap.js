...
import { unstable_useEnhancedEffect as useEnhancedEffect, unstable_debounce as debounce } from '@mui/utils';
...
export default function useSliderElementsOverlap(axis) {
  const {
    setRef: setThumbRef,
