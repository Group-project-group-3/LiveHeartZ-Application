...
export interface ButtonGroupOwnProps {
     ...
     * @default 'primary'
     */
    color?: OverridableStringUnion<'primary' | 'secondary' | 'tertiary', ButtonGroupPropsColorOverrides>;
    /**
     ...
     * @default 'outlined'
     */
    variant?: OverridableStringUnion<'text' | 'outlined' | 'filled' | 'filledTonal' | 'elevated', ButtonGroupPropsVariantOverrides>;
    /**
...
export interface ButtonGroupOwnerState extends PartiallyRequired<ButtonGroupProps, 'color' | 'disabled' | 'disableElevation' | 'disableRipple' | 'disableTouchRipple' | 'fullWidth' | 'orientation' | 'size' | 'variant'> {
}
