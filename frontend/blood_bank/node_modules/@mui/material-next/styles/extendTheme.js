...
export default function extendTheme(options = {}, ...args) {
  ...
  const _createThemeWithoutVa = createThemeWithoutVars(_extends({}, input, {
      ...
      ref: _extends({}, input.ref, {
        typeface,
        palette: deepmerge(md3CommonPalette, (_input$ref2 = input.ref) == null ? void 0 : _input$ref2.palette)
      }),
      sys: _extends({}, input.sys, {
        typescale,
        state,
        motion,
        color: _extends({}, md3LightColors, (_colorSchemesInput$li = colorSchemesInput.light) == null || (_colorSchemesInput$li = _colorSchemesInput$li.sys) == null ? void 0 : _colorSchemesInput$li.color),
        elevation: (_colorSchemesInput$li2 = (_colorSchemesInput$li3 = colorSchemesInput.light) == null || (_colorSchemesInput$li3 = _colorSchemesInput$li3.sys) == null ? void 0 : _colorSchemesInput$li3.elevation) != null ? _colorSchemesInput$li2 : elevationLight,
        shape
      }),
      palette: _extends({}, colorSchemesInput.light && ((_colorSchemesInput$li4 = colorSchemesInput.light) == null ? void 0 : _colorSchemesInput$li4.palette))
    })),
    {
  ...
  const {
    ...
    ref: _extends({}, input.ref, {
      typeface,
      palette: deepmerge(md3CommonPalette, (_input$ref3 = input.ref) == null ? void 0 : _input$ref3.palette)
    }),
    sys: _extends({}, input.sys, {
      typescale,
      state,
      motion,
      color: _extends({}, md3DarkColors, (_colorSchemesInput$da2 = colorSchemesInput.dark) == null || (_colorSchemesInput$da2 = _colorSchemesInput$da2.sys) == null ? void 0 : _colorSchemesInput$da2.color),
      elevation: (_colorSchemesInput$da3 = (_colorSchemesInput$da4 = colorSchemesInput.dark) == null || (_colorSchemesInput$da4 = _colorSchemesInput$da4.sys) == null ? void 0 : _colorSchemesInput$da4.elevation) != null ? _colorSchemesInput$da3 : elevationDark,
      shape
    })
  });
  const {
