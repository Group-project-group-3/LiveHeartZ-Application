...
import { unstable_capitalize as capitalize, internal_resolveProps as resolveProps } from '@mui/utils';
...
const Button = /*#__PURE__*/React.forwardRef(function Button(inProps, ref) {
  ...
  const resolvedProps = resolveProps(contextProps != null ? contextProps : {}, inProps);
  ...
  const positionClassName = buttonGroupButtonContextPositionClassName != null ? buttonGroupButtonContextPositionClassName : '';
  const rootProps = useSlotProps({
    ...
    ownerState,
    className: clsx(contextProps == null ? void 0 : contextProps.className, positionClassName)
  });
