...
export interface MenuTypeMap<AdditionalProps = {}, RootComponent extends React.ElementType = 'ul'> {
    props: AdditionalProps & StandardProps<Omit<PopoverProps, 'slots' | 'slotProps' | 'open' | 'onClose'>, 'children'> & {
        /**
...
export type MenuProps<RootComponent extends React.ElementType = MenuTypeMap['defaultComponent'], AdditionalProps = {}> = OverrideProps<MenuTypeMap<AdditionalProps, RootComponent>, RootComponent> & {
