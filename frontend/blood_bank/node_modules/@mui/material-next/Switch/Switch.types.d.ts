...
export interface SwitchOwnProps extends StandardProps<SwitchBaseProps, 'checkedIcon' | 'color' | 'icon' | 'sx'> {
    /**
...
export type SwitchProps<RootComponentType extends React.ElementType = SwitchTypeMap['defaultComponent'], AdditionalProps = {}> = OverrideProps<SwitchTypeMap<AdditionalProps, RootComponentType>, RootComponentType>;
