...
const FormControl = /*#__PURE__*/React.forwardRef(function FormControl(inProps, forwardedRef) {
  ...
  const [filled, setFilled] = React.useState(() => {
    ...
    if (children) {
      React.Children.forEach(children, child => {
        var _child$props$slotProp;
        if (!(0, _utils.unstable_isMuiElement)(child, ['Input', 'Select'])) {
          return;
        }
        if ( /*#__PURE__*/React.isValidElement(child) && ((0, _utils2.isFilled)(child.props, true) || (0, _utils2.isFilled)((_child$props$slotProp = child.props.slotProps) == null ? void 0 : _child$props$slotProp.input, true))) {
          initialFilled = true;
        }
      });
    }
