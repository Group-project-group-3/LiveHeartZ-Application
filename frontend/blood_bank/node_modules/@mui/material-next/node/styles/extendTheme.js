...
function extendTheme(options = {}, ...args) {
  var _input$sys, _input$sys2, _input$sys3, _input$sys4, _input$ref, _input$sys5, _input$ref2, _colorSchemesInput$li, _colorSchemesInput$li2, _colorSchemesInput$li3, _colorSchemesInput$li4, _colorSchemesInput$da, _input$ref3, _colorSchemesInput$da2, _colorSchemesInput$da3, _colorSchemesInput$da4, _colorSchemesInput$li5, _colorSchemesInput$li6, _colorSchemesInput$da5, _colorSchemesInput$da6;
  const {
  ...
  const _createThemeWithoutVa = (0, _styles.createTheme)((0, _extends2.default)({}, input, {
      ...
      ref: (0, _extends2.default)({}, input.ref, {
        typeface,
        palette: (0, _utils.deepmerge)(_palette.default, (_input$ref2 = input.ref) == null ? void 0 : _input$ref2.palette)
      }),
      sys: (0, _extends2.default)({}, input.sys, {
        typescale,
        state,
        motion,
        color: (0, _extends2.default)({}, md3LightColors, (_colorSchemesInput$li = colorSchemesInput.light) == null || (_colorSchemesInput$li = _colorSchemesInput$li.sys) == null ? void 0 : _colorSchemesInput$li.color),
        elevation: (_colorSchemesInput$li2 = (_colorSchemesInput$li3 = colorSchemesInput.light) == null || (_colorSchemesInput$li3 = _colorSchemesInput$li3.sys) == null ? void 0 : _colorSchemesInput$li3.elevation) != null ? _colorSchemesInput$li2 : _elevation.elevationLight,
        shape
      }),
      palette: (0, _extends2.default)({}, colorSchemesInput.light && ((_colorSchemesInput$li4 = colorSchemesInput.light) == null ? void 0 : _colorSchemesInput$li4.palette))
    })),
    {
  ...
  const {
    ...
    ref: (0, _extends2.default)({}, input.ref, {
      typeface,
      palette: (0, _utils.deepmerge)(_palette.default, (_input$ref3 = input.ref) == null ? void 0 : _input$ref3.palette)
    }),
    sys: (0, _extends2.default)({}, input.sys, {
      typescale,
      state,
      motion,
      color: (0, _extends2.default)({}, md3DarkColors, (_colorSchemesInput$da2 = colorSchemesInput.dark) == null || (_colorSchemesInput$da2 = _colorSchemesInput$da2.sys) == null ? void 0 : _colorSchemesInput$da2.color),
      elevation: (_colorSchemesInput$da3 = (_colorSchemesInput$da4 = colorSchemesInput.dark) == null || (_colorSchemesInput$da4 = _colorSchemesInput$da4.sys) == null ? void 0 : _colorSchemesInput$da4.elevation) != null ? _colorSchemesInput$da3 : _elevation.elevationDark,
      shape
    })
  });
  const {
    ...
    colorSchemes: (0, _extends2.default)({}, colorSchemesInput, {
      light: (0, _extends2.default)({}, colorSchemesInput.light, {
        ...
        opacity: (0, _extends2.default)({
          ...
          switchTrack: 0.38
        }, (_colorSchemesInput$li5 = colorSchemesInput.light) == null ? void 0 : _colorSchemesInput$li5.opacity),
        overlays: ((_colorSchemesInput$li6 = colorSchemesInput.light) == null ? void 0 : _colorSchemesInput$li6.overlays) || defaultLightOverlays,
        sys: {
          color: lightSysColor,
          elevation: lightSysElevation
        },
      ...
      dark: (0, _extends2.default)({}, colorSchemesInput.dark, {
        ...
        opacity: (0, _extends2.default)({
          ...
          switchTrack: 0.3
        }, (_colorSchemesInput$da5 = colorSchemesInput.dark) == null ? void 0 : _colorSchemesInput$da5.opacity),
        overlays: ((_colorSchemesInput$da6 = colorSchemesInput.dark) == null ? void 0 : _colorSchemesInput$da6.overlays) || defaultDarkOverlays,
        sys: {
          color: darkSysColor,
          elevation: darkSysElevation
        },
