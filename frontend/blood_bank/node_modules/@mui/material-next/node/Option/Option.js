...
var _ListContext = _interopRequireDefault(require("@mui/material/List/ListContext"));
...
const _excluded = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "className", "disabled", "label"]; // TODO v6: Replace with @mui/material-next when the List components are available
...
const useUtilityClasses = ownerState => {
  ...
  const composedClasses = (0, _composeClasses.unstable_composeClasses)(slots, _optionClasses.getOptionUtilityClass, classes);
  return (0, _extends2.default)({}, classes, composedClasses);
};
const OptionRoot = (0, _styles.styled)(_ButtonBase.default, {
  ...
  [`&.${_optionClasses.default.selected}`]: {
    ...
    [`&.${_optionClasses.default.focusVisible}`]: {
  ...
  [`&.${_optionClasses.default.selected}:hover`]: {
  ...
  [`&.${_optionClasses.default.disabled}`]: {
...
const Option = /*#__PURE__*/React.forwardRef(function Option(inProps, ref) {
  ...
  const handleRef = (0, _utils.unstable_useForkRef)(optionRef, ref);
  const {
    getRootProps,
    disabled,
    focusVisible,
  ...
  (0, _utils.unstable_useEnhancedEffect)(() => {
    if (autoFocus) {
      if (optionRef.current) {
        ...
        console.error('MUI: Unable to set focus to an Option whose component has not been rendered.');
      }
    }
  }, [autoFocus]);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ListContext.default.Provider, {
    value: childContext,
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(OptionRoot, (0, _extends2.default)({}, rootProps))
  });
});
