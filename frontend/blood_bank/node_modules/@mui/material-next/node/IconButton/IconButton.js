...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', color !== 'default' && `color${(0, _utils.unstable_capitalize)(color)}`, edge && `edge${(0, _utils.unstable_capitalize)(edge)}`, `size${(0, _utils.unstable_capitalize)(size)}`]
  };
...
const IconButtonRoot = (0, _styled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.color !== 'default' && styles[`color${(0, _utils.unstable_capitalize)(ownerState.color)}`], ownerState.edge && styles[`edge${(0, _utils.unstable_capitalize)(ownerState.edge)}`], styles[`size${(0, _utils.unstable_capitalize)(ownerState.size)}`]];
  }
})(({
  theme,
  ownerState
...
process.env.NODE_ENV !== "production" ? IconButton.propTypes /* remove-proptypes */ = {
   ...
   */
  sx: _propTypes.default /* @typescript-to-proptypes-ignore */.oneOfType([_propTypes.default.arrayOf(_propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.object, _propTypes.default.bool])), _propTypes.default.func, _propTypes.default.object])
} : void 0;
