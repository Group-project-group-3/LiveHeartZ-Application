...
var _SwitchBase = _interopRequireDefault(require("@mui/material/internal/SwitchBase"));
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', edge && `edge${(0, _utils.unstable_capitalize)(edge)}`, `size${(0, _utils.unstable_capitalize)(size)}`],
    switchBase: ['switchBase', `color${(0, _utils.unstable_capitalize)(color)}`, checked && 'checked', disabled && 'disabled'],
    thumb: ['thumb'],
    track: ['track'],
    input: ['input']
  };
...
const SwitchRoot = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.edge && styles[`edge${(0, _utils.unstable_capitalize)(ownerState.edge)}`], styles[`size${(0, _utils.unstable_capitalize)(ownerState.size)}`]];
  }
})(({
  ownerState
}) => (0, _extends2.default)({
...
const SwitchSwitchBase = (0, _styled.default)(_SwitchBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    }, ownerState.color !== 'default' && styles[`color${(0, _utils.unstable_capitalize)(ownerState.color)}`]];
  }
})(({
  theme
}) => ({
