...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `anchorOrigin${(0, _utils.unstable_capitalize)(anchorOrigin.vertical)}${(0, _utils.unstable_capitalize)(anchorOrigin.horizontal)}`]
  };
...
const SnackbarRoot = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`anchorOrigin${(0, _utils.unstable_capitalize)(ownerState.anchorOrigin.vertical)}${(0, _utils.unstable_capitalize)(ownerState.anchorOrigin.horizontal)}`]];
  }
})(({
  theme,
  ownerState
