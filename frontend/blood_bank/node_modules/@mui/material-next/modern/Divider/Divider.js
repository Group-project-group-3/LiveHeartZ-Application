...
const _excluded = ["absolute", "children", "className", "component", "flexItem", "orientation", "role", "textAlign", "variant"];
...
const DividerRoot = styled('div', {
  ...
  return _extends({
    ...
    left: 0,
    width: '100%'
  }, ownerState.variant === 'inset' && ownerState.orientation === 'horizontal' && {
    marginLeft: '16px'
  }, ownerState.variant === 'inset' && ownerState.orientation === 'vertical' && {
    marginTop: '16px'
