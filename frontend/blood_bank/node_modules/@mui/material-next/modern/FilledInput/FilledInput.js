...
import { InputBaseRoot, InputBaseInput, rootOverridesResolver as inputBaseRootOverridesResolver, inputOverridesResolver as inputBaseInputOverridesResolver } from '../InputBase/InputBase';
...
const FilledInputRoot = styled(InputBaseRoot, {
  ...
  return _extends({
    ...
    '--md-comp-filled-input-focus-active-indicator-color': tokens.sys.color[ownerState.color ?? 'primary'],
