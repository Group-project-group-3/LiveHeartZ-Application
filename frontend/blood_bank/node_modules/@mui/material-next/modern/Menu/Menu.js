...
const _excluded = ["onEntering"],
  ...
  _excluded3 = ["className", "disabledItemsFocusable", "disableListWrap"];
...
import { HTMLElementType, unstable_getScrollbarSize as getScrollbarSize, unstable_ownerDocument as ownerDocument } from '@mui/utils';
...
const MenuInner = /*#__PURE__*/React.forwardRef(function Menu(inProps, ref) {
  ...
  const {
    ...
    otherMenuListProps = _objectWithoutPropertiesLoose(MenuListProps, _excluded3);
  const {
    contextValue,
    getListboxProps,
    dispatch,
  ...
  const listboxProps = useSlotProps({
    ...
    getSlotProps: otherHandlers => {
      return getListboxProps(_extends({
        onKeyDown: handleListKeyDown
      }, otherHandlers));
    },
    externalSlotProps: args => _extends({}, typeof slotProps.listbox === 'function' ? slotProps.listbox(args) : slotProps.listbox, otherMenuListProps),
    additionalProps: {
      ref: listRef
...
const Menu = /*#__PURE__*/React.forwardRef(function Menu(inProps, ref) {
  ...
  return !upperDropdownContext ? /*#__PURE__*/_jsx(DropdownContext.Provider, {
    value: dropdownContextValue,
    children: /*#__PURE__*/_jsx(MenuInner, _extends({
      ref: ref
    }, inProps))
  }) : /*#__PURE__*/_jsx(MenuInner, _extends({
    ref: ref
  }, inProps));
});
